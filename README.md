...
notebooks: `backend_colab.ipynb` (the one to run — install, Drive, serve) and
`video_editor_colab.ipynb` (same, plus the in-cell editor GUI and manual render
cells). See `colab_version/README.md`.
